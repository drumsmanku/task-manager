    ...
    <div className={styles.container}>
      ...
      <form className={styles.form}>
        ...
        <div className={styles.inputContainer}>
          <h4 style={{alignSelf:'start', paddingLeft:'2.2rem', fontWeight:600, marginTop:'0.5rem'}}>Create Account</h4>
          <div style={DivStyles}>
        ...
        <div style={{width:'100%', display:'flex', justifyContent:'center'}}>
          <p style={{width:'85%', textAlign:'left', fontWeight:600,fontSize:'small', marginTop:0}}>By enrolling your mobile phone number, you consent to receive automated security notifications via text message from TaskER. Message and data rates may apply.
          </p>
        </div>

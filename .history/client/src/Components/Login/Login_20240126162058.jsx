...
function Login() {
  ...
  const login = (event) => {
    ...
    axios.post('https://task-manager-backend-1.onrender.com/login', user)
      .then(res => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.mainBody}>
        ...
        <button className={styles.notLoggedInButton}  onClick={()=>{navigate('/register')}}>Create your TaskER account</button>
      </div>

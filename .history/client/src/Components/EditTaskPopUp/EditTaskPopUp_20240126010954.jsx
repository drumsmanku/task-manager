            ...
            <div className={styles.modalEditContent} onClick={handleClickInside}>
              ...
              <h2>edit your product </h2>
                ...
                <div style={{display:'flex', width:'100%', marginBottom:'2rem'}}>
                  <input type="text" name="title" value={test[0]&& test[0].title} onChange={handleChange} placeholder="Title"/>
                </div>

                <div style={{display:'flex', width:'100%', marginBottom:'2rem'}}>
                  <input type="text" name="description" value={test[0]&& test[0].description} onChange={handleChange} placeholder="edit description" />
                </div>

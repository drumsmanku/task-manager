      ...
      <div className={styles.mainBody}>
        <form className={styles.form}>
          ...
          <div className={styles.inputContainer}>
            <h3 className={styles.signInText}>Sign In for Students.</h3>
        ...
        <div style={{display:'flex', marginTop:'2.5rem'}}>
          ...
          <span className={styles.newToMusic} >New to DoubtShare?</span>
          <hr className={styles.wideLine} />
        </div>

        <button className={styles.notLoggedInButton}  onClick={()=>{navigate('/register/student')}}>Create your DoubtShare account</button>
      </div>
